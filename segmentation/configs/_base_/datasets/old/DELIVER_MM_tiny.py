...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir='samples/images/tiny_training', #training training2 validation
        # ev_dir='samples/event/training',
        # lid_dir='samples/lidar/training',
        # depth_dir='samples/depth/training',
        mod_dir=['samples/depth/tiny_training','samples/event/tiny_training','samples/lidar/tiny_training'],
        ...
        ann_dir='samples/annotations/tiny_training', #training training2 validation
    ...
    val=dict(
        ...
        img_dir='samples/images/tiny_validation', #validation test2
        ...
        mod_dir=['samples/depth/tiny_validation','samples/event/tiny_validation','samples/lidar/tiny_validation'],
        mod_suffix=['_depth_front.png','_event_front.png','_lidar_front.png'],
        ...
        ann_dir='samples/annotations/tiny_validation', #validation test2
    ...
    test=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir='samples/images/tiny_test', #test validation
        # ev_dir='samples/event/test',
        # lid_dir='samples/lidar/test',
        # depth_dir='samples/depth/test',
        mod_dir=['samples/depth/tiny_test','samples/event/tiny_test','samples/lidar/tiny_test'],
        mod_suffix=['_depth_front.png','_event_front.png','_lidar_front.png'],
        # in_dir='samples/events/test', #test validation
        # x_dir='samples/x/test', #test validation
        ann_dir='samples/annotations/tiny_test', #test validation
        pipeline=test_pipeline,
        modalities_name=modalities_name,
        modalities_ch=modalities_ch))
