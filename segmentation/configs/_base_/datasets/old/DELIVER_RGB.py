...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir='samples/images/training', #training training2 validation
        ...
        ann_dir='samples/annotations/training', #training training2 validation
    ...
    val=dict(
        ...
        # mod_dir=['samples/event/training2','samples/lidar/training2','samples/depth/training2'],
        # mod_suffix=['_depth_front.png','_event_front.png','_lidar_front.png'],
    ...
    test=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir='samples/images/test', #test validation
        ...
        ann_dir='samples/annotations/test', #test validation
        pipeline=test_pipeline,
        modalities_name=modalities_name,
        modalities_ch=modalities_ch))
