...
mod_dir_tr='projected_to_rgb/event_camera/train',
mod_dir_val='projected_to_rgb/event_camera/val',
mod_dir_test='projected_to_rgb/event_camera/val',
mod_suffix='_event_camera.npz',
stride=(640,640)
img_scale = (1920,1080)
...
# dataset settings
mod_norm_cfg =dict(
mean=[0.485, 0.456, 0.406,0.08768561, 0.08779435, 0.], std=[0.229, 0.224, 0.225,0.4479273728078597,0.4006636354755567,1.], to_rgb=[True,False]
)
...
evaluation = dict(start=1, interval=1, by_epoch=True, metric='mIoU', save_best='mIoU', resize_dim=(1920,1080), case=None)
