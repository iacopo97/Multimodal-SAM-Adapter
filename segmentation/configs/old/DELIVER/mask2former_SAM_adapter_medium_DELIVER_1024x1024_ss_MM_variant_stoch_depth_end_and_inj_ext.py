...
_base_ = [
    ...
    '../_base_/schedules/schedule_80ep.py'
]
log_config = dict(
    interval=50,
    hooks=[
...
pretrained='pretrained/sam_vit_b_image_encoder_no_neck.pth'
resume_from='/media/data4/sora/projects/ViT-Adapter/segmentation/work_dirs/mask2former_SAM_adapter_medium_DELIVER_1024x1024_ss_MM_variant_stoch_depth_end_and_inj_ext/epoch_40.pth'
