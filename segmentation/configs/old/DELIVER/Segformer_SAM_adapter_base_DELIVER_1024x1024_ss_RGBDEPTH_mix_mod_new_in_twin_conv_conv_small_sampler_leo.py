...
# crop_size =(896,896)
# stride=(368,200)
# checkpoint_conv='/leonardo_scratch/fast/IscrC_MM-Ad/project/MultimodalSeg/vit-adapter-mm/segmentation/pretrained/convnext-small_in21k-pre_3rdparty_in1k-384px_20221219-96f0bb87.pth'
...
evaluation = dict(start=1, interval=1, by_epoch=True, metric='mIoU', save_best='mIoU', resize_dim=(1024,1024), case=['motionblur', 'overexposure', 'underexposure', 'lidarjitter', 'eventlowres'])#['motionblur', 'overexposure', 'underexposure', 'lidarjitter', 'depthlowres'])#, show=True), out_dir="/media/data4/sora/projects/ViT-Adapter/segmentation/training_DELIVER_dataset_RGB_SAMADAPTER_1024x1024/test")#by_epoch=True, _real_train _deliver_pipeline
