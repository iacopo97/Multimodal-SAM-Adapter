...
model = dict(
    ...
    backbone=dict( 
        _delete_=True,
        type='SAMAdaptermultimodalselectorgamma_nogammafinalonebranchSoftmax',
        img_size=crop_size[0],
...
optimizer = dict(_delete_=True, type='AdamW', lr=2e-4, betas=(0.9, 0.999), weight_decay=0.01,#lr=2e-5,weight_decay=0.05 lr=6e-5 CMNExt lr=2e-4
