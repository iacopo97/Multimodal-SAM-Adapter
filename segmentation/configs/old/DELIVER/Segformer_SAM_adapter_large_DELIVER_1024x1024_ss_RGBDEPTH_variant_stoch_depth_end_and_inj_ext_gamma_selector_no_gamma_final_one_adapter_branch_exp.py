...
optimizer = dict(_delete_=True, type='AdamW', lr=6e-5, betas=(0.9, 0.999), weight_decay=0.01,#lr=2e-5,weight_decay=0.05 lr=2e-4 with geminifusion
                 constructor='DefaultOptimizerConstructor')#,#LayerDecayOptimizerConstructor
                #  paramwise_cfg=dict(num_layers=24, layer_decay_rate=0.90))
lr_config = dict(_delete_=True,
                 policy='poly',
                 warmup='exp', #original'linear' 'exp'
