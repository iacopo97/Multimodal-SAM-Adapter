...
# show=True, out_dir="/media/data4/sora/projects/ViT-Adapter/segmentation/training_DELIVER_dataset_RGB_SAMADAPTER/test")#by_epoch=True, _real_train _deliver_pipeline