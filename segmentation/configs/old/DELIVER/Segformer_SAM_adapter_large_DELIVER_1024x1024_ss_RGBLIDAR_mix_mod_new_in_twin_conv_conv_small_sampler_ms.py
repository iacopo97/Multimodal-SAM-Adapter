...
model = dict(
    ...
    backbone=dict( 
        _delete_=True,
        type='SAMAdapterbimodalMixModNewInTwinCONVNEWMS',
        img_size=crop_size[0],
...
optimizer = dict(_delete_=True, type='AdamW', lr=3e-4, betas=(0.9, 0.999), weight_decay=0.01,#lr=2e-5,weight_decay=0.05 lr=2e-4 geminifusion lr=6e-5 CMNEXT
