...
class EncoderDecoderDebug(BaseSegmentor):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(EncoderDecoderDebug, self).__init__(init_cfg)
    ...
    def extract_feat(self, img):
        ...
        d=make_dot(x[0].mean(), params=dict(self.backbone.named_parameters()))
        d.format="png"
        d.render("test")
        if self.with_neck:
            x = self.neck(x)
    ...
    def inference(self, img, img_meta, rescale):
        ...
        assert self.test_cfg.mode in ['slide', 'whole', 'whole_dim']
