...
from .adapter_modules_multimodal_2_adapter_branch_sequential import SpatialPriorModule, InteractionBlock, deform_inputs
...
class SAMAdapterbimodal2branchseq(ImageEncoderViT):
