...
from .adapter_modules_multimodal_gamma_spatial_image_based_no_gamma_extractor import SpatialPriorModule, SpatialPriorModulewithGammaSpatial, InteractionBlock, deform_inputs
...
class SAMAdaptermultimodalselectorgamma(ImageEncoderViT):
