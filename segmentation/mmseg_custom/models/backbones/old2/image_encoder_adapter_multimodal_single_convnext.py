...
from .adapter_modules_single_convnext import SpatialPriorModule, SpatialPriorModuleSinglemodal, InteractionBlock, deform_inputs
...
class SAMAdaptermultimodalsingleConvNext(ImageEncoderViT):
    def __init__(self, pretrain_size=1024 #1024
        ...
        if ('rgb' in self.modalities_name):
            ...
            self.spm = SpatialPriorModuleSinglemodal(inplanes=conv_inplane, embed_dim=embed_dim, with_cp=False, in_channels=self.in_ch_im, arch=arch, checkpoint=checkpoint)
