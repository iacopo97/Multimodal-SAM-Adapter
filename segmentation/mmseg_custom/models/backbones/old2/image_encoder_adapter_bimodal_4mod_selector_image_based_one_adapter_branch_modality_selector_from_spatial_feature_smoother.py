...
from .adapter_modules_multimodal_4mod_selector_image_based_one_adapter_branch_modality_selector_from_spatial_feature_smoother import SpatialPriorModule, SpatialPriorModuleModSelector, InteractionBlock, deform_inputs
...
class SAMAdapterbimodal4modselectoronebranchModFromSpsmooth(ImageEncoderViT):
    ...
    def _init_weights(self, m):
        ...
        #     nn.init.constant_(m.weight, 1e-6)
        # #m==nn.Conv2d(4*self.embed_dim, self.num_mod, kernel_size=(1,1), stride=1, padding=0, bias=True):
            # m.weight.data.zero_()
            # m.bias.data.zero_()
