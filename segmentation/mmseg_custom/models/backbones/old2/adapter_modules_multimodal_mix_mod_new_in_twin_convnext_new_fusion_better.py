...
class SpatialPriorModuleBimodal(nn.Module):
    ...
    def forward(self, x,x_other_mod):
        ...
        def _inner_forward(x,x_other_mod):
            ...
            # w1_conc,w2_conc,w3_conc,w4_conc=w1_sum[:,1],w2_sum[:,1],w3_sum[:,1],w4_sum[:,1]
            # c1=c1*w1_conc+c1_sum*w1_sum[:,0]
            # c2=c2*w2_conc+c2_sum*w2_sum[:,0]
            # c3=c3*w3_conc+c3_sum*w3_sum[:,0]
            # c4=c4*w4_conc+c4_sum*w4_sum[:,0]
