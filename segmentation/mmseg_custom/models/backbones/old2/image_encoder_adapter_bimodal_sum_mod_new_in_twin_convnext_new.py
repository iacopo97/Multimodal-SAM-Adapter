...
from .adapter_modules_multimodal_sum_mod_new_in_twin_convnext_new import SpatialPriorModule, SpatialPriorModuleBimodal, InteractionBlock, deform_inputs
...
class SAMAdapterbimodalSumModNewInTwinConvNEW(ImageEncoderViT):
