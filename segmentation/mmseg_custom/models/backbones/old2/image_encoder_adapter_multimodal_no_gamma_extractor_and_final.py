...
from .adapter_modules_multimodal_no_gamma_extractor import SpatialPriorModule, InteractionBlock, deform_inputs
...
class SAMAdaptermultimodalnogamma(ImageEncoderViT):
