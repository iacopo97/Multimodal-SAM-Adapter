...
from .adapter_modules_multimodal_stoch_depth_end_and_inj_ext import SpatialPriorModule, InteractionBlock, deform_inputs
...
class SAMAdaptermultimodal(ImageEncoderViT):
