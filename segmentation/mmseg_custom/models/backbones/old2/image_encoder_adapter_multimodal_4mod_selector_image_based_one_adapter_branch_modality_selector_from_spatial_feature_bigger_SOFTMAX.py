...
from .adapter_modules_multimodal_4mod_selector_image_based_one_adapter_branch_modality_selector_from_spatial_feature_bigger import SpatialPriorModule, SpatialPriorModuleModSelector, InteractionBlock, deform_inputs
...
class SAMAdaptermultimodal4modselectoronebranchModFromSpbiggerSOFTMAX(ImageEncoderViT):
    def __init__(self, pretrain_size=1024 #1024
        ...
        self.multimodal_drop_path=nn.Dropout2d(drop_multimodal_path) if drop_multimodal_path > 0. else nn.Identity() #DropPath is the stochastic Depth, so it is pruning a modality instead of another turning all the elements in zeros
