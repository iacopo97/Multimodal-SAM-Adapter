...
class SAMAdapterbimodal4modselectoronebranchEARLYFUSION(ImageEncoderViT):
    def __init__(self, pretrain_size=1024 #1024
        ...
        if ('rgb' in self.modalities_name) and self.num_mod>1:
            ...
            self.spm = SpatialPriorModule(inplanes=conv_inplane, embed_dim=embed_dim, with_cp=False, in_channels=self.in_ch_im+self.modalities_ch[1])
