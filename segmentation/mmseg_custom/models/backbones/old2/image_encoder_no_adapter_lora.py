...
# from .adapter_modules_multimodal_4mod_selector_image_based_one_adapter_branch_modality_selector_from_single_channel_by_mod_lighter import SpatialPriorModule, SpatialPriorModuleModSelectorsinglechannel, InteractionBlock, deform_inputs, ModalitySelectorViT
from .adapter_modules_dummy import InteractionBlock
...
class SAMnoAdapterLORA(SAMLoraImgEncoder):
    ...
    def forward(self, x):
        ...
        for i, layer in enumerate(self.interactions):
            ...
            # if self.num_mod>1:
            x=layer(x, self.blocks[indexes[0]:indexes[-1] + 1],
                     H, W)
    ...
    # , mod_selector_gamma1, mod_selector_gamma2, mod_selector_gamma3,mod_selector_gamma4
