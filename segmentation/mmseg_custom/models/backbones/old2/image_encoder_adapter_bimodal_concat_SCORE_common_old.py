...
class SAMAdapterbimodalconcatSCOREcommon(ImageEncoderViT):
    ...
    def forward(self, x):
        ...
        if ('rgb' in self.modalities_name):
            ...
            # else:
            c1, c2, c3, c4,c5_other_modalities = self.spm(x)
        ...
        if self.num_mod>1:
            ...
            c1_other_modalities, c2_other_modalities, c3_other_modalities, c4_other_modalities,c5_other_modalities = self.spm_other_modalities(x_other_modalities)
