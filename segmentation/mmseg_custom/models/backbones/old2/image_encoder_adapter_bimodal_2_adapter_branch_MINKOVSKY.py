...
class SAMAdapterbimodal2branchMINK(ImageEncoderViT):
    def __init__(self, pretrain_size=1024 #1024
        ...
        if self.num_mod>1:
            self.spm_other_modalities=SpatialPriorModuleSparse(inplanes=conv_inplane, embed_dim=embed_dim, in_channels=self.modalities_ch[1],with_cp=False,D=2,bs=2)#inplanes=64, embed_dim=1024, spatial_dim=1024, in_ch=1,with_cp=False,D=2
