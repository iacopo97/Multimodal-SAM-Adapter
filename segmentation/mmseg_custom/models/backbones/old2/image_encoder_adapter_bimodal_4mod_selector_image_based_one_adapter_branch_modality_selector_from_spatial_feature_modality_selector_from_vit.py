...
from .adapter_modules_multimodal_4mod_selector_image_based_one_adapter_branch_modality_selector_from_spatial_feature_modality_selector_from_vit import SpatialPriorModule, ModalityCombiner, SpatialPriorModulecombinedspatial, InteractionBlock, deform_inputs
...
class SAMAdapterbimodal4modselectoronebranchModFromSpModfromViT(ImageEncoderViT):
    def __init__(self, pretrain_size=1024 #1024
        ...
        if ('rgb' in self.modalities_name):
            ...
            self.spm_comb_spatial = SpatialPriorModulecombinedspatial(inplanes=conv_inplane, embed_dim=embed_dim, with_cp=False, in_channels=self.in_ch_im, num_mod=self.num_mod)
    ...
    def forward(self, x):
        ...
        if ('rgb' in self.modalities_name):
            ...
            # c1, c2, c3, c4, mod_selector_gamma1, mod_selector_gamma2, mod_selector_gamma3, mod_selector_gamma4 = self.spm_gamma_spatial(x)
            concat_c,c1,c2,c3,c4=self.spm_comb_spatial(x) #mod_selector_gamma2_t,mod_selector_gamma3_t,mod_selector_gamma4_t
        ...
        mod_selector_gamma1,mod_selector_gamma2,mod_selector_gamma3,mod_selector_gamma4=self.mod_combiner(concat_c, x, c1_shape_orig, c2_shape_orig, c3_shape_orig, c4_shape_orig)
