...
from .adapter_modules_multimodal_mix_mod_new_in_twin_spm_new_ms import SpatialPriorModule, SpatialPriorModuleBimodal, InteractionBlock, deform_inputs
...
class SAMAdapterbimodalMixModNewInTwinSPMNEWMS(ImageEncoderViT):
