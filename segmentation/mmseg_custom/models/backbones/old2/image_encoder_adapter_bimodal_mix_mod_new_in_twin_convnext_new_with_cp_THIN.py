...
from .adapter_modules_multimodal_mix_mod_new_in_twin_convnext_new_with_cp_THIN import SpatialPriorModule, SpatialPriorModuleBimodal, InteractionBlock, deform_inputs
...
class SAMAdapterbimodalMixModNewInTwinConvNEWwithcpTHIN(ImageEncoderViT):
