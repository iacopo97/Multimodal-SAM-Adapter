...
from .adapter_modules_multimodal_ import SpatialPriorModule, SpatialPriorModulenoc1, SpatialPriorModulewithGammaSpatial, InteractionBlock, deform_inputs
...
class SAMAdapterbimodalconcatnoRELUsumonlyRGB(ImageEncoderViT):
