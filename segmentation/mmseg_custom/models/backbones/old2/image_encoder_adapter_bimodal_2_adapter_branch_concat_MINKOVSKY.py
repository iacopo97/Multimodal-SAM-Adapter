...
from .adapter_modules_multimodal_2_adapter_branch_MINKOVSKY import SpatialPriorModule, SpatialPriorModuleSparse, InteractionBlock, deform_inputs
...
class SAMAdapterbimodal2branchconcatMINK(ImageEncoderViT):
    def __init__(self, pretrain_size=1024 #1024
        ...
        if self.num_mod>1:
            self.spm_other_modalities=SpatialPriorModuleSparse(inplanes=conv_inplane, embed_dim=embed_dim, in_channels=self.modalities_ch[1],with_cp=False,D=2,bs=bs)
