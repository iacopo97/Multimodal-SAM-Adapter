...
from .base.image_encoder_double_patch import ImageEncoderViT
from .adapter_modules_multimodal_mix_mod_new_in_twin_convnext_new_with_cp_thinner import SpatialPriorModule, SpatialPriorModuleBimodal, InteractionBlock, deform_inputs
...
class SAMAdapterbimodalMixModNewInTwinConvNEWwithcpthinnerpacth(ImageEncoderViT):
    ...
    def forward(self, x):
        ...
        x_other_modalities, H, W = self.patch_embed_other_modalities(x_other_modalities, H, W)
        # x=x.flatten(2)
        # x=x.flatten(1,2)
        bs, n, dim = x.shape
