...
from .adapter_modules_multimodal_mix_mod_new_in_shared_convnext_new import SpatialPriorModule, SpatialPriorModuleBimodal, InteractionBlock, deform_inputs
...
class SAMAdapterbimodalMixModNewInSharedConvNEW(ImageEncoderViT):
