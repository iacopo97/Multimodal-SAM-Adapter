...
class SAMAdapterbimodalconcatLORA(SAMLoraImgEncoder):
...
if __name__ == "__main__":
    ...
    dummy_input = torch.randn(1, 6, 256, 256)  # Batch size 1, 10 channels, 256x256 image
    
    # Instantiate the model
    model = SAMAdapterbimodalconcat(
        pretrain_size=1024,
        num_heads=16,
        conv_inplane=64,
        n_points=4,
