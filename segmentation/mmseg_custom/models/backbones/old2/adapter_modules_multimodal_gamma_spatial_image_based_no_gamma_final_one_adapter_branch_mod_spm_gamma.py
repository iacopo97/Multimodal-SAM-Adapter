...
class SpatialPriorModulewithGammaSpatial(nn.Module):
    ...
    def forward(self, x):
        ...
        def _inner_forward(x):
            ...
            mod_selector_gamma1=self.layer_norm1(mod_selector_gamma1)
            mod_selector_gamma2=self.layer_norm2(mod_selector_gamma2)
            mod_selector_gamma3=self.layer_norm3(mod_selector_gamma3)
            mod_selector_gamma4=self.layer_norm4(mod_selector_gamma4)
