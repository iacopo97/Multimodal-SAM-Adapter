...
class SAMAdapterbimodalconcatGELU(ImageEncoderViT):
    def __init__(self, pretrain_size=1024 #1024
        ...
        self.merger1=nn.Sequential(*[nn.GELU(),nn.Linear(embed_dim*2,embed_dim)])
        self.merger2=nn.Sequential(*[nn.GELU(),nn.Linear(embed_dim*2,embed_dim)])
