...
from .adapter_modules_multimodal_gamma_spatial_image_based_no_gamma_final_two_adapter_branch_with_concat_inj import SpatialPriorModule, SpatialPriorModulewithGammaSpatial, InteractionBlock, deform_inputs
...
class SAMAdaptermultimodalselectorgamma_nogammafinaltwobranchRelunormsum_concatinj(ImageEncoderViT):
    ...
    def forward(self, x):
        ...
        for i, layer in enumerate(self.interactions):
            ...
            if self.num_mod>1:
                x,c,c2_4_other_modalities_cumulative=layer(x, c, c2_4_other_modalities_cumulative, self.blocks[indexes[0]:indexes[-1] + 1],
                    deform_inputs1, deform_inputs2, H, W)
            else:
                x,c,_=layer(x, c, None, self.blocks[indexes[0]:indexes[-1] + 1],
                    deform_inputs1, deform_inputs2, H, W)
