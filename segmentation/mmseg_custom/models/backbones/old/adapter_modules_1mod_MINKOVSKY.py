...
class SpatialPriorModule(nn.Module):
    def __init__(self, inplanes=64, embed_dim=384, in_ch=3,with_cp=False):
        super().__init__()
        self.with_cp = with_cp
...
class SpatialPriorModuleSparse(nn.Module):
    def __init__(self, inplanes=64, embed_dim=1024, spatial_dim=1024, in_channels=1,with_cp=False,D=2, bs=1):
        super().__init__()
        self.with_cp = with_cp
        self.coordinates = dense_coordinates(torch.Size([2, in_channels, spatial_dim,spatial_dim]))
