...
class SpatialPriorModulewithGammaSpatial(nn.Module):
    def __init__(self, inplanes=64, embed_dim=384, with_cp=False, in_channels=3, num_mod=4):
        ...
        self.fc1 = nn.Conv2d(inplanes, embed_dim, kernel_size=1, stride=1, padding=0, bias=True)
        self.fc2 = nn.Conv2d(2 * inplanes, embed_dim, kernel_size=1, stride=1, padding=0, bias=True)#+self.num_mod
        ...
        self.fc4 = nn.Conv2d(4 * inplanes, embed_dim, kernel_size=1, stride=1, padding=0, bias=True)#+self.num_mod
    ...
    def forward(self, x):
        ...
        def _inner_forward(x):
            ...
            return c1, c2, c3, c4, mod_selector_gamma_inj
        # mod_selector_gamma2, mod_selector_gamma3, mod_selector_gamma4, mod_selector_gamma_inj
