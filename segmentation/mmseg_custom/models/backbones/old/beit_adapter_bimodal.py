...
from .adapter_modules_1mod import SpatialPriorModule, deform_inputs
from .adapter_modules_1mod import InteractionBlockWithCls as InteractionBlock
_logger = logging.getLogger(__name__)


@BACKBONES.register_module()
class BEiTAdapterBimodal(BEiT):
    ...
    def forward(self, x):
        ...
        for i, layer in enumerate(self.interactions):
            ...
            x_rgb, c, cls = layer(x_rgb, c, cls, self.blocks[indexes[0]:indexes[-1] + 1],
