...
class SAMAdaptermultimodalselectorgamma_nogammafinalonebranchReluNorm(ImageEncoderViT):
    def __init__(self, pretrain_size=1024 #1024
        ...
        self.relu_mod1=nn.ReLU()
        self.relu_mod2=nn.ReLU()
        self.relu_mod3=nn.ReLU()
        self.relu_mod4=nn.ReLU()
