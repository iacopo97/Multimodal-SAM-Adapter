                    ...
                    # for j in range(0,len(self.modalities_name)):
                        # if self.modalities_name[i]!=self.modalities_name[j]:
                            if self.modalities_name[i]=='rgb':
                                # cum_extraction_primary_modality = cum_extraction_primary_modality + attn + self.drop_multimodal(attn_cum[j-1])
                            ...
                            # elif self.modalities_name[j]=='rgb':
                                # cum_extraction_other_modalities_t[i-1] = cum_extraction_other_modalities_t[i-1] + attn_cum[i-1]+self.drop_multimodal(attn)
                                # cum_extraction_other_modalities_t[i-1] = cum_extraction_other_modalities_t[i-1] + attn_cum[i-1]+self.drop_multimodal(attn)
                            ...
                            #     # pass
                                ...
                                # cum_extraction_other_modalities_t[i-1] = cum_extraction_other_modalities_t[i-1] + attn_cum[i-1]+self.drop_multimodal(attn_cum[j-1])
