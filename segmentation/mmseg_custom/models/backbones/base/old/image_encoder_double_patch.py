...
class ImageEncoderViT(nn.Module):
    def __init__(
        ...
        self.patch_embed_other_modalities = PatchEmbed(
            kernel_size=(patch_size, patch_size),
            stride=(patch_size, patch_size),
            in_chans=in_chans,
            embed_dim=embed_dim,
    ...
    def init_weights(self, pretrained=None):
        ...
        if isinstance(pretrained, str):
            ...
            self.patch_embed_other_modalities.proj.weight.data.copy_(self.patch_embed.proj.weight)
            self.patch_embed_other_modalities.proj.bias.data.copy_(self.patch_embed.proj.bias)
