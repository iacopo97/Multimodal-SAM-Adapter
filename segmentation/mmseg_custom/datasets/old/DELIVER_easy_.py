...
class DELIVER_easy(CustomDataset):
    """DELIVER dataset.
    """
    ...
    def __init__(self,
        ...
        if len(modalities_name)>1:
            ...
            self.img_infos = self.load_annotations_modalities(self.img_dir, self.img_suffix,None,None,self.modalities_name, self.ann_dir,
                                                self.seg_map_suffix, self.split)
